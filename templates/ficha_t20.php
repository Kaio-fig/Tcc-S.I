...
<body>
            ...
            <div id="atributos" class="tab-content active">
                <div class="bloco">
                    ...
                    <div class="atributos-grid">
                        <div class="atributo"><label>FORÇA</label>
                            <div class="valor">4</div>
                        </div>
                        <div class="atributo"><label>DESTREZA</label>
                            <div class="valor">2</div>
                        </div>
                        <div class="atributo"><label>CONSTITUIÇÃO</label>
                            <div class="valor">4</div>
                        </div>
                        <div class="atributo"><label>INTELIGÊNCIA</label>
                            <div class="valor">0</div>
                        </div>
                        <div class="atributo"><label>SABEDORIA</label>
                            <div class="valor">1</div>
                        </div>
                        <div class="atributo"><label>CARISMA</label>
                            <div class="valor">-1</div>
                        </div>
                    </div>
                </div>
            ...
            <div id="poderes" class="tab-content">
                <div class="bloco">
                    ...
                    <div class="poder-item">
                        <h4>Mordida Poderosa (Raça)</h4>
                        <p>Você possui uma arma natural de mordida (dano 1d6, crítico x2, perfuração), com a qual recebe +2 em testes de agarrar. Uma vez por rodada, quando usa a ação agredir para atacar com outra arma, pode gastar 1 PM para fazer um ataque corpo a corpo extra com a mordida.</p>
                    </div>
                    <div class="poder-item">
                        <h4>Predador Aquático (Raça)</h4>
                        <p>Você tem deslocamento de natação 6m e recebe +1 na Defesa e +2 em Furtividade.</p>
                    </div>
                    <div class="poder-item">
                        <h4>Surto Reptiliano (Raça)</h4>
                        <p>Uma vez por cena, você pode gastar 1 PM para realizar uma ação de movimento adicional em seu turno.</p>
                    </div>
                    <div class="poder-item">
                        <h4>Confissão (Origem)</h4>
                        <p>Você pode usar Intimidação para interrogar sem custo e em uma hora.</p>
                    </div>
                    <div class="poder-item">
                        <h4>Ataque Poderoso (Guerreiro)</h4>
                        <p>Sempre que faz um ataque corpo a corpo, você pode sofrer –2 no teste de ataque para receber +5 na rolagem de dano.</p>
                    </div>
                    <div class="poder-item">
                        <h4>Ambidestria (Combatente)</h4>
                        <p>Se estiver empunhando duas armas e fizer a ação agredir, você pode fazer dois ataques, um com cada arma. Se fizer isso, sofre –2 em todos os testes de ataque até o seu próximo turno.</p>
                    </div>
                    <div class="poder-item">
                        <h4>Durão (Guerreiro)</h4>
                        <p>A partir do 3º nível, sempre que sofre dano, você pode gastar 3 PM para reduzir esse dano à metade.</p>
                    </div>
                    <div class="poder-item">
                        <h4>Ataque Extra (Guerreiro)</h4>
                        <p>A partir do 6º nível, quando usa a ação agredir, você pode gastar 2 PM para realizar um ataque adicional uma vez por rodada.</p>
                    </div>
                    <div class="poder-item">
                        <h4>Ao Sabor do Destino (Guerreiro)</h4>
                        <ul class="poder-lista">
                            <li>6º Nível: +2 em Luta</li>
                            <li>7º Nível: +1 na Defesa</li>
                            <li>8º Nível: +1 nas rolagens de dano</li>
                            <li>9º Nível: +1 em um atributo (DES)</li>
                            <li>11º Nível: +2 em Acrobacia</li>
                        </ul>
                        <p class="poder-nota">*Não usar itens mágicos.</p>
                    </div>
                </div>
            </div>
    ...
    <footer class="botoes-rodape">
        <a href="meus_personagens.php" class="btn btn-secondary">Voltar para Meus Personagens</a>
        <button type="button" class="btn btn-primary" disabled>Salvar Personagem</button>
    </footer>
